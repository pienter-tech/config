return {
    ...
    },
    {
        ...
        keys = {
            { mode = "n", "<localleader>nn", ":Obsidian new<CR>", desc = "Create a new note." },
            { mode = "n", "<localleader>ff", ":Obsidian quick_switch<CR>", desc = "Find and open note" },
            { mode = "n", "<localleader>gf", ":Obsidian follow_link<CR>", desc = "Open link" },
            { mode = "n", "<localleader>gi", ":Obsidian quick_switch root<CR>", desc = "Go to root index" },
            { mode = "n", "<localleader>gt", ":Obsidian quick_switch todo-root<CR>", desc = "Go to todo index" },
            { mode = "n", "<localleader>gw", ":Obsidian quick_switch house<CR>", desc = "Go to work@home" },
            { mode = "n", "<localleader>gh", ":Obsidian follow_link hsplit<CR>", desc = "Open link in horizontal split" },
            { mode = "n", "<localleader>gc", ":Obsidian follow_link csplit<CR>", desc = "Open link in vertical split" },
            { mode = "n", "<localleader>jj", ":Obsidian today<CR>", desc = "Open todays note" },
            { mode = "n", "<localleader>jn", ":Obsidian today +1<CR>", desc = "Open tomorrow note" },
            { mode = "n", "<localleader>jp", ":Obsidian today -1<CR>", desc = "Open yesterday note" },
            {
                mode = "n",
                "<localleader>fj",
                ":Obsidian dailies -50 2<CR>",
            ...
            { mode = "n", "<localleader>tt", ":Obsidian toggle_checkbox<CR>", desc = "Cycle through checkbox options" },
            {
                mode = "n",
                "<localleader>fc",
                ":Obsidian toc<CR>",
